...
<Suggestion
  ...
  color="#22C55E"
  onPress={() => setSearchText('completed')}
/>
            </View>
...
function Suggestion({ icon, text, color, onPress }: any) {
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.8}
